        ...
        <div id="kt_aside_menu"
            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item ">
                    <a href="/profile/mypatients/all" class="kt-menu__link ">
...
@endif
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true"><a href="/profile/d/Appointments/Create/{{auth()->user()->id}}" class="kt-menu__link "><i
                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                        class="kt-menu__link-text">Add Appointment</span></a></li>
                            <li class="kt-menu__item " aria-haspopup="true"><a href="/profile/Appointments/{{auth()->user()->id}}" class="kt-menu__link "><i
                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                ...
                <li class="kt-menu__item ">
                    <a href="/profile/CaseHistory/add/Case" class="kt-menu__link ">
                    <i class="kt-menu__link-icon flaticon-suitcase"></i>
                ...
                <li class="kt-menu__item "><a href="/profile/Documents/create/d" class="kt-menu__link "><i
                ...
                <li class="kt-menu__item " aria-haspopup="true"><a href="/profile/edit/{{auth()->user()->id}}" class="kt-menu__link "><i
