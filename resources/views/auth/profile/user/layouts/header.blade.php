...
<script>
createChatBot(host = 'https://duckling-server-theamineguesmi.cloud.okteto.net',
...
<a href="/profile/Appointments/{{auth()->user()->id}}" class="kt-menu__link "><span class="kt-menu__link-text">Appointments</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>


                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
<a href="/profile/CaseHistory/{{auth()->user()->id}}" class="kt-menu__link "><span class="kt-menu__link-text">Case Histories</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>


                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
<a href="/profile/Documents/{{auth()->user()->id}}" class="kt-menu__link "><span class="kt-menu__link-text">Documents</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>


                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
<a href="/profile/Prescriptions/{{auth()->user()->id}}" class="kt-menu__link "><span class="kt-menu__link-text">Prescriptions</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>
                            @if(auth()->user()->type == 'doctor')
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"  data-ktmenu-submenu-toggle="click" aria-haspopup="true">
<a href="/profile/timeSchedulesForDoctor/{{auth()->user()->id}}" class="kt-menu__link "><span class="kt-menu__link-text">Schedules</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>
                            @endif
...
@endif</span>
                            ...
                            <div class="kt-notification">
                                <a href="/profile/{{auth()->user()->id}}/type"
